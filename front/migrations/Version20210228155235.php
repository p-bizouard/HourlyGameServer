 ...
 */
final class Version20210228155235 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE game (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`, image VARCHAR(255) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`, port INT NOT NULL, created DATETIME NOT NULL, updated DATETIME NOT NULL, queryport INT NOT NULL, UNIQUE INDEX UNIQ_232B318C5E237E06 (name), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        $this->abortIf($this->connection->getDatabasePlatform()->getName() !== 'mysql', 'Migration can only be executed safely on \'mysql\'.');
        ...
        $this->addSql('CREATE TABLE server (id INT AUTO_INCREMENT NOT NULL, owner_id INT DEFAULT NULL, game_id INT DEFAULT NULL, last_history_id INT DEFAULT NULL, instance_id INT DEFAULT NULL, last_backup_id INT DEFAULT NULL, last_check_id INT DEFAULT NULL, created DATETIME NOT NULL, updated DATETIME NOT NULL, name VARCHAR(255) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`, password VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT NULL COLLATE `utf8mb4_unicode_ci`, INDEX IDX_5A6DD5F67E3C61F9 (owner_id), INDEX IDX_5A6DD5F6E48FD905 (game_id), INDEX IDX_5A6DD5F68F2C079 (last_check_id), INDEX IDX_5A6DD5F63A51721D (instance_id), INDEX IDX_5A6DD5F6F771EEB8 (last_history_id), INDEX IDX_5A6DD5F68472B84F (last_backup_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        $this->abortIf($this->connection->getDatabasePlatform()->getName() !== 'mysql', 'Migration can only be executed safely on \'mysql\'.');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP TABLE server_check');
        $this->abortIf($this->connection->getDatabasePlatform()->getName() !== 'mysql', 'Migration can only be executed safely on \'mysql\'.');
